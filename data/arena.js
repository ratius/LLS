const ArenaData = [
	...
	'Opponent': [
		...
		{'name': 'Yu', 'text': '……なに書こう<br><span class="tips">編集者註：7文字だけです。編集ミスではありません。<\/span>'},
	...
	'Opponent': [
		...
		{'num': '', 'text': '<span class="tips">※この回のエンディングテキストはありません。<br>ステージ31以降は、ステージ1～30の内容が繰り返されます。<\/span>'},
	...
	'Opponent': [
		...
		{'name': 'Sakura', 'text': 'ほんとに喜んでもらえるか不安だったけど……<br>たくさんの子たちがもっと見たいって言ってくれたの<br>ドールも嬉しそうで、がんばってよかった…<br><span class="tips">編集者註：ここだけ三点リーダが単独で使用されているが、おそらくライターのミス。<\/span>'},
	...
	'Opponent': [
		...
		{'name': 'Akiru', 'text': 'パンパカパーン！　あれもしたいこれもしたい、私の抱負はー<br>「興味津々！」まるでクワドラプル<span class="tips">※<\/span>によるフィニッシュね！<br>よ、良かったんだよね？　んで終わっても。……ダメだった？<br><span class="tips">※クワドラプル(quadruple)…フィギュアスケートにおける「4回転ジャンプ」のこと。<\/span>'},
	...
	'Opponent': [
		...
		{'name': 'geass', 'namealt': 'ラクシャータ', 'text': 'へえ、面白い。ライブでバトルねえ<br>ランウズ<span class="tips">※<\/span>なんかに負けるんじゃないわよ<br>じゃあ本番いってみようか<br><span class="tips">※原文の誤植。正しくは「ラウンズ」<\/span>'},
		...
		{'name': 'geass', 'num': '53', 'namealt': 'ラクシャータ', 'text': '私の開発した兵器は、プリン伯爵<span class="tips">※<\/span>のと違って<br>使用する人間や生存率向上をちゃあんと考えているのさ<br>共同作業なんてしたくもないね……あーあ、気持ち悪っ<br><span class="tips">※「プリン伯爵」とは、ロイド・アスプルンドのこと。<\/span>'},
		{'name': 'geass', 'num': '54', 'namealt': 'コーネリア', 'text': 'ブリタニアの魔女と呼ばれた私に勝つつもりか？<br>黒の騎士団だと……？　テロになど屈せぬ<br>エリア11は私が綺麗にして愛するユフィに渡すのだ<br><span class="tips">※ ステージ39での登場時と全く同じ<\/span>'},
		{'name': 'geass', 'num': '55', 'namealt': 'ナナリー', 'text': '私は、エリア11の総督に新しく着任しました<br>ナナリー・ヴィ・ブリタニアです<br>ユフィ姉妹が目指した、等しく優しい世界を作りたいのです'},
		{'name': 'geass', 'num': '56', 'namealt': 'ヴィレッタ', 'text': '今は教師の仮面を被り、機密情報局でロロと共にルルーシュを<br>監視している。ゼロの正体を突止めた功績で男爵位を手に入れ<br>たと言うのに……くそ……！<br><span class="tips">※ ステージ36での登場時と全く同じ<\/span>'},
		...
		{'name': 'geass', 'num': '??', 'namealt': 'ナナリー', 'text': 'お兄様がセロ<span class="tips">※<\/span>だったのですね<br>私がお兄様を止めなければなりません<br>お兄様の罪は私が背負います<br><span class="tips">※原文の誤植。正しくは「ゼロ」<\/span><br><span class="tips">ナナリーのセリフはランダム？私はこの台詞に遭遇することはできませんでした<\/span>'}
	]},
	...
	'Opponent': [
		...
		{'name': 'Koyuki', 'text': '特別な思い出、小雪にもあるよ。GWで初めて観た「ジゼル<span class="tips">※<\/span>」<br>鳥肌が立つほど感動して、涙がでちゃったの<br>このゴールデンライブも誰かの特別な思い出になるといいな♪<br><span class="tips">※バレエ作品のひとつ。<\/span>'},
		...
		{'name': 'Yu', 'text': '星が見えづらい季節でも……観察ができるようにって<br>天体望遠鏡を買ってもらったのがGWだったよ<br>もうすぐ……水星の逆行運動<span class="tips">※<\/span>を観察するんだ<br><span class="tips">※地球から見た惑星の見かけの動きが、普段と逆方向になること。<\/span>'},
		...
		{'name': 'Misaki', 'text': 'そうね、悪くないわ。私たちは強く輝き、その輝きが……<br>応援するみんなを輝かせる。そんな一体感をつくるのよね<br>ブレイクショット<span class="tips">※<\/span>で飛び散るボールのような勢いを感じるわ！<br><span class="tips">※ビリヤードにおいて、ゲームの最初に行われるショット（突き）のこと。<\/span>'},
		...
		{'name': 'Reine', 'text': 'よ～し、麗音からが本当のゴールデンライブの始まりだよっ！<br>みんな～！　ぴっかぴかのダンスを楽しんでねー！！<br>……水星の逆行はGW後<span class="tips">※<\/span>って遊宇から聞いたのは黙っとこっと<br><span class="tips">※水星の逆行運動は、2022年5月10日からしばらく観測することができた。つまり時事ネタ。<\/span'},
	...
	'Opponent': [
		{'num': 'OP', 'text': '今回のライブ♪アリーナはフューチャーライブ<br>スクールアイドルの皆さんはそれぞれミライへと想いをはせているようです'},
		...
		{'name': 'Yuuka', 'text': 'でも、雨を題材にした歌もいっぱいありますし、雨の歌を雨の日に歌ったら、みなさんと共感できて<br>素晴らしいステージになると思いませんか？'},
		...
		{'name': 'Akemi', 'text': '雨の日に友達とアイアイ傘して帰るのも、楽しそうよね～♪<br>普段と違う距離感で、お互いにちょっとドキドキしちゃったりして……キャーッ！'},
		{'name': 'Chiduko', 'text': '雨の日だって、考え方次第でこんなに素敵なことに思えてくるんですのね。楽しくなってきましたわ♡'},
	...
	'Opponent': [
		...
		{'num': '1-3', 'name': 'Marika', 'text': 'あったかくなってきたから、練習頑張ってみようかな～<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '2-3', 'name': 'Minami', 'text': '自分の歌をみんなに聴いてもらえるのって、<br>すごく幸せですっ♪<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '3-3', 'name': 'Aya', 'text': 'もっと人に見られることに慣れないと……<br>あ、あんまり見ないでくださいっ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '4-3', 'name': 'Ayumi', 'text': 'さち子がまた変なことやってる……<br>あなたからも何か言ってあげてよ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '5-3', 'name': 'Seira', 'text': 'もっともっと、上を目指してみたいんです！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '6-3', 'name': 'Sachiko', 'text': 'メイド服の落とし物！？<br>そ、そ、それは我と何の関係もないっ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '7-3', 'name': 'Akiru', 'text': '私に出来ないことなんてないわ……<br>多分、ね<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '8-3', 'name': 'Yumi', 'text': 'くたびれた？<br>だらしないわね、体力づくりに付き合いましょうか？<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
	]},
	{'title': '汎用セリフ集 (東雲学院) ※未完成',
	'Opponent': [
		...
		{'num': '1-3', 'name': 'Coco', 'text': 'スクールアイドルになりたくなったら<br>いつでも声をかけてくださいね～<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		{'num': '2-1', 'name': 'Sana', 'text': '<span class="tips">(まだ確認できていません。情報募集中！)<\/span>'},
		{'num': '2-2', 'name': 'Sana', 'text': '最高のライブをするんだから！<br>あんたが私についてきなさいよねっ！<br>き、緊張なんてしてないわよっ'},
		{'num': '2-3', 'name': 'Sana', 'text': '今度のステージ、来るんでしょうね？<br>来なかったらどうなるか分かってる？<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '3-3', 'name': 'Christina', 'text': '神様の祝福がありますように……♪<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '4-3', 'name': 'Yuri', 'text': 'シビれるような<br>すげーかっこいいライブするからさ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '5-3', 'name': 'Rika', 'text': 'この衣装とあの衣装では、どちらが好ましい？<br>……なるほど、メモしておこう<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '6-3', 'name': 'Haruka', 'text': '今日は毛糸を買いに行こうと思ってるんです<br>お姉ちゃんにマフラー編もうかなと思って<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '7-3', 'name': 'Kasane', 'text': '明日新曲の練習するから<br>キミにも来てもらいたいなあ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '8-3', 'name': 'Mizuki', 'text': '気合い入れてやってみるよ！<br>あたしと一緒に頑張ろう！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'}
	]},
	{'title': '汎用セリフ集 (千歳橋高校) ',
	'Opponent': [
		{'num': '1-1', 'name': 'Yu', 'text': '（断られちゃったら……どうしよう……）<br>……セッション……する……？'},
		{'num': '1-2', 'name': 'Yu', 'text': '（星がきれい……<br>惑星がすれ違うみたいに、私も待ってれば、会えるのかな）<br>あっ……また、会えたね'},
		{'num': '1-3', 'name': 'Yu', 'text': '（一緒におさんぽに行こうよ……言えないけど）<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		{'num': '2-1', 'name': 'Fumie', 'text': 'ややっ！　これは奇遇ですね！　私はもちろん<br>電脳空間の素晴らしさを伝えにきました！　私のセッションを<br>見ればサイバー衣装が増えること間違いなし！　布教布教！'},
		{'num': '2-2', 'name': 'Fumie', 'text': '見てくださいこのフィギュア！　 限定版なんですよ！<br>布教用に10体ほど買ったので、あなたにもおすそ分けです！<br><span class="tips">編集者註：1行目の空白は「全角1.5文字分」になっている。ライターのミス？<\/span>'},
		{'num': '2-3', 'name': 'Fumie', 'text': 'るうちゃんを誘って<br>ゲームのコラボカフェに行ってまいります！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '3-3', 'name': 'Akemi', 'text': '元気？て　ちゃんと心のシャッター押してる？<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '4-3', 'name': 'Iruka', 'text': 'いっぱい踊るから、君もいっぱい見ててね！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '5-3', 'name': 'Reine', 'text': '麗音に会いに来てくれる人って<br>みんな嬉しそう♪　麗音も嬉しいよぉ！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '6-3', 'name': 'Nanaka', 'text': '言葉にするのは難しい感情もある<br>それでも私は書き続けるよ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '7-3', 'name': 'Saki', 'text': 'ふふーん<br>私のことをほめても、何にも出ないぞっ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '8-3', 'name': 'Ru', 'text': 'ほっ、ほっ……<br>ランニングは得意です……<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '9-3', 'name': 'Nagi', 'text': 'いっぱい歌うよ<br>部活楽しいねー<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'}
	]},
	{'title': '汎用セリフ集 (橙黄学園)',
	'Opponent': [
		...
		{'num': '1-3', 'name': 'Shun', 'text': 'キミってのんびりしてそうで<br>意外としっかり者だよねっ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '2-3', 'name': 'Fumi', 'text': 'わ、わわっ！<br>めがねをふいてもぐるぐるは取れませんよ～<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '3-3', 'name': 'Tsurugi', 'text': '気を引き締めて、今年も頑張るよ<br>よろしくね！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '4-3', 'name': 'Yuuka', 'text': '放送部の見学ですか？<br>興味を持ってくれて嬉しい……大歓迎です♪<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '5-3', 'name': 'Fuu', 'text': '今日のトレーニング、つきあってよ<br>アドバイスほしいんだよね<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '6-3', 'name': 'Misaki', 'text': '何か用？<br>ふふ、それなら私のことを捕まえてみて♪<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '7-3', 'name': 'Himeno', 'text': 'ステージで元気いっぱい<br>ダンスできるのが楽しいんです！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '8-3', 'name': 'Koyuki', 'text': '部室で待ってるよ<br>練習がんばろーね<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '9-3', 'name': 'Ryo', 'text': '雪ちゃんを見なかったかい？<br>ちょっと話したいことがあってね<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'}
	]},
	{'title': '汎用セリフ集 (紫苑女学院)',
	'Opponent': [
		...
		{'num': '1-3', 'name': 'Mikoto', 'text': '今日の風紀は……なかなかいい感じです！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '2-3', 'name': 'Chiduko', 'text': 'わたくしと愛の課外授業に出かけませんこと？<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '3-3', 'name': 'Hitomi', 'text': '俺には俺の風紀がある<br>口出しは無用だ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '4-3', 'name': 'Akira', 'text': '最近こたつ出したんだ！<br>あったまっていかない？<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '5-3', 'name': 'Yuka', 'text': 'たまには2人で出かけようよ！<br>おしゃれしていくからさー<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '6-3', 'name': 'Sayuri', 'text': 'これより訓練に入る！<br>まずはボーカルレッスンから♪<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '7-3', 'name': 'Sakura', 'text': '今日は姉さんは機関に追われてるみたい<br>寝ながらうめいてた<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '8-3', 'name': 'Sakuya', 'text': 'これ以上私に近づいたら……危険よ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '9-3', 'name': 'Mutsuki', 'text': 'すやすや……思いついたぞぉ……<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'}
	]},
	...
	'Opponent': [
		...
		{'num': '1-3', 'name': 'Ranpha', 'text': '歌うの、楽しいデス！<br>いっしょに歌いまショー！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '2-3', 'name': 'Rakshata', 'text': 'ウエストにくびれが欲しい？<br>一緒にベリーダンスはいかがですか？<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '3-3', 'name': 'Rebecca', 'text': '部屋の乱れはココロの乱れ<br>日々、掃除は欠かさずにね<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '4-3', 'name': 'Isabella', 'text': '授業が難しい？<br>私が面倒を見てやろうか<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '5-3', 'name': 'Jennifer', 'text': '元気にしてる？<br>……その笑顔、100点満点ねっ！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '6-3', 'name': 'Maria', 'text': '自分のことを知ってもらいたい……<br>そんな気持ちで踊っているのかもしれないわ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		{'num': '7-1', 'name': 'Leo', 'text': 'レオは「さばいばる」に強い、言われた<br>「さばいばる」、なに？　レオ、わからない……'},
		{'num': '7-2', 'name': 'Leo', 'text': 'レオ、歌うの、好き<br>みんなで歌うこと、もっと好き！'},
		{'num': '7-3', 'name': 'Leo', 'text': 'お祝いだぞ！　いっぱい踊ろう！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '8-3', 'name': 'Yukari', 'text': '最近はラジオ体操に真剣に取り組んでいます！<br>なかなか奥が深いのですね～<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、ホーム画面で表示されるセリフの一つ<\/span>'}
	]},
	{'title': 'ドリームセッション (通常)',
	'Opponent': [
	...
	'Opponent': [
		...
		{'name': 'geass', 'num': '5', 'namealt': 'アーニャ', 'text': '間に合った？　なんとか……<br>良かった。なんかあるとジェリー<span class="tips">※<\/span>怒るから<br><span class="tips">※「ジェリー」とは、ジェレミア・ゴットバルトのこと。<\/span>'},
