const ArenaData = [
	...
	'Opponent': [
		...
		{'name': 'geass', 'namealt': '咲世子', 'text': 'ナナリー様、私がライブ会場へ潜入・制圧いたします<br>ナナリー様に相応しい舞台を用意して<br>メイドの意地をお見せします'},
		...
		{'num': '', 'text': '<span class="tips">(スペシャルセッション発生時のテキストの情報募集中！)<\/span>'}
	]},
	{'title': '汎用セリフ集 (青藍高校)',
	'Opponent': [
	...
	'Opponent': [
		...
		{'num': '8-1', 'name': 'Mizuki', 'text': '<span class="tips">(まだ確認できていません。情報募集中！)<\/span>'},
		{'num': '8-2', 'name': 'Mizuki', 'text': 'あたしの趣味？　もちろんバスケ！<br>シュートが決まる瞬間も気持ちいいけど<br>味方のナイスプレーを見るのも気持ちいいんだ！'},
		{'num': '8-3', 'name': 'Mizuki', 'text': '<span class="tips">(まだ確認できていません。情報募集中！)<\/span>'}
	]},
	{'title': '汎用セリフ集 (千歳橋高校) ',
	'Opponent': [
...
const todo = [
	...
	'sub': '「コードギアス」コラボ特別回　開催：2022/04/13 - 2022/04/25',
	'Opponent': [
		{'num': 'OP', 'text': '（オープニングテキストの情報募集中）'},
		{'name': 'geass', 'namealt': '', 'text': 'test'},
		{'num': 'ED', 'text': '（エンディングテキストの情報募集中）'}
	]},
	{'title': '第回 ライブ♪アリーナ　',
