...
},
{
	...
	'tube': 'xV0pIO6ZiJk',
	'tag': ['meets', 'Kaho', 'Kozue'],
	'desc': '中間テストを目前に控える中、二人で「勉強」がテーマの雑談をしていく。二人の好きな教科も判明。'
},
{
	...
	'desc': '中間テストの重圧から解放された二人の雑談。ツッコミ役のいない空間で、あらぬ方向に話題が……！？<br>リンクラ語録『ちくわ』：聞こえたことが頭に入らず素通りする。聞き流す。筒抜けなどの意味。'
},
{
...
},
{
	...
	'tube': 'wflHX_IFknw',
	'tag': ['meets', 'Sayaka'],
	'desc': '個人配信にも慣れてきたさやか。トークの上手さを花帆に褒められたのをきっかけに、ラジオのような配信に挑戦！<br>With×MEETS AFTER（YouTubeでは公開されていない）で、リスナーの呼称が「村人」に決定。'
},
{
...
},
{
	...
	'desc': '当初は花帆も出演する予定であったが、キャストの楡井希実氏の体調不良により、予定を変更して3人での配信になった{{出演者変更のお知らせ:1673136658315890688}}。'
},
{
	...
	'tube': '',
	'tag': ['live', 'Kaho', 'Sayaka', 'Kozue', 'Tsuzuri'],
	'setlist': ['DEEPNESS', 'MC', 'Holiday∞Holiday', '水彩世界', 'Tragic Drops', 'AWOKE', 'MC', 'Dream Believers', 'MC'],
...
},
{
	...
	'setlist': ['Reflection in the Mirror', 'Sparkly Spot', 'MC', '眩耀夜行', 'Mirage Voyage', 'MC', '永遠のEuphoria'],
...
},
{
	...
	'desc': '当初は瑠璃乃の個人配信が行われる予定であったが{{予定表:1688852174024138752}}、8月上旬に配信中止が相次いだことにより内容が変更された。この回は音声のみの配信で3Dモデルは未登場。また、With×MEETS AFTERは行われなかった。'
},
{
