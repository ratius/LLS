const ArenaData = [
	...
	'Opponent': [
		...
		{'num': '1-3', 'name': 'Shun', 'text': 'キミってのんびりしてそうで<br>意外としっかり者だよねっ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '2-3', 'name': 'Fumi', 'text': 'わ、わわっ！<br>めがねをふいてもぐるぐるは取れませんよ～<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '3-3', 'name': 'Tsurugi', 'text': '気を引き締めて、今年も頑張るよ<br>よろしくね！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '4-3', 'name': 'Yuuka', 'text': '放送部の見学ですか？<br>興味を持ってくれて嬉しい……大歓迎です♪<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '5-3', 'name': 'Fuu', 'text': '今日のトレーニング、つきあってよ<br>アドバイスほしいんだよね<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '6-3', 'name': 'Misaki', 'text': '何か用？<br>ふふ、それなら私のことを捕まえてみて♪<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '7-3', 'name': 'Himeno', 'text': 'ステージで元気いっぱい<br>ダンスできるのが楽しいんです！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '8-3', 'name': 'Koyuki', 'text': '部室で待ってるよ<br>練習がんばろーね<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '9-3', 'name': 'Ryo', 'text': '雪ちゃんを見なかったかい？<br>ちょっと話したいことがあってね<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
	]},
	...
	'Opponent': [
		...
		{'num': '1-3', 'name': 'Ranpha', 'text': '歌うの、楽しいデス！<br>いっしょに歌いまショー！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '2-3', 'name': 'Rakshata', 'text': 'ウエストにくびれが欲しい？<br>一緒にベリーダンスはいかがですか？<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '3-3', 'name': 'Rebecca', 'text': '部屋の乱れはココロの乱れ<br>日々、掃除は欠かさずにね<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '4-3', 'name': 'Isabella', 'text': '授業が難しい？<br>私が面倒を見てやろうか<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '5-3', 'name': 'Jennifer', 'text': '元気にしてる？<br>……その笑顔、100点満点ねっ！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '6-3', 'name': 'Maria', 'text': '自分のことを知ってもらいたい……<br>そんな気持ちで踊っているのかもしれないわ<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		{'num': '7-1', 'name': 'Leo', 'text': 'レオは「さばいばる」に強い、言われた<br>「さばいばる」、なに？　レオ、わからない……'},
		{'num': '7-2', 'name': 'Leo', 'text': 'レオ、歌うの、好き<br>みんなで歌うこと、もっと好き！'},
		{'num': '7-3', 'name': 'Leo', 'text': 'お祝いだぞ！　いっぱい踊ろう！<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
		...
		{'num': '8-3', 'name': 'Yukari', 'text': '最近はラジオ体操に真剣に取り組んでいます！<br>なかなか奥が深いのですね～<br><span class="tips">※キラキラ☆転入生フェスティバルSSRの、メイン画面で表示されるセリフの一つ<\/span>'},
	]},
