...
const LiveList = [
{
	...
	'tube': '0HMWTWiEqag',
	'tags': ['Kaho', 'Sayaka', 'Kozue', 'Tsuzuri'],
...
},
{
	...
	'tube': 'KBnb1KbeocA',
	'tags': ['live', 'Kaho', 'Sayaka', 'Kozue', 'Tsuzuri'],
...
},
{
	...
	'title': '新入生紹介配信',
	'tube': 'Mh8Oe9o9Rm8',
	'tags': ['meets', 'Kaho', 'Sayaka', 'Kozue', 'Tsuzuri'],
...
},
{
	...
	'title': '撫子祭直前配信',
	'tube': 'kn-MgGPvI-c',
	'tags': ['meets', 'Sayaka', 'Kozue', 'Tsuzuri'],
...
},
{
	...
	'tube': 'SwqT5S5VbFQ',
	'tags': ['meets', 'Kaho', 'Sayaka', 'Kozue', 'Tsuzuri', 'Rurino'],
...
},
{
	...
	'tube': 'kg1uEGDXUNg',
	'tags': ['live', 'Kaho', 'Sayaka', 'Kozue', 'Tsuzuri', 'Rurino'],
	'setlist': ['Reflection in the Mirror', 'Sparkly Spot', 'MC', '眩耀夜行', 'Mirage Voyage', 'MC', '永遠のEuphoria(4人Ver.)'],
	'desc': '今月のFes×LIVEのテーマは「七夕」。ライブ会場は、蓮ノ空女学院の校舎の前に設営された屋外ステージ。<br>大沢瑠璃乃がFes×LIVE初参戦！ 今回からFes×LIVE AFTERの配信も始まった。'
},
{
...
},
{
	...
	'title': '合宿ラジオ',
	'tube': '4PW3o5haQyw',
	'tags': ['meets', 'Sayaka', 'Kozue', 'Tsuzuri', 'Rurino', 'Megumi'],
...
},
{
	...
	'tube': '5XVatqO6cPk',
	'tags': ['meets', 'Kaho', 'Sayaka', 'Kozue', 'Tsuzuri', 'Rurino', 'Megumi'],
...
},
{
	...
	'tags': ['live', 'Kaho', 'Sayaka', 'Kozue', 'Tsuzuri', 'Rurino', 'Megumi'],
	'desc': 'ライブ会場は、徳光海岸の特設ステージ。ついに慈も参戦し、出演は6人に！<br>このFes×LIVEはストーリー第10話との密接なつながりがあるため、公式ではストーリーと抱き合わせで配信されている（右のリンクではライブ部分から視聴開始になるようになっている）。',
},
{
...
},
{
	...
	'title': '蓮ノ空２年生の会',
	'tube': 'O2LOfOhevsE',
	'tags': ['meets', 'Kozue', 'Tsuzuri', 'Megumi'],
...
},
{
	...
	'tags': ['live', 'Kaho', 'Sayaka', 'Kozue', 'Tsuzuri', 'Rurino', 'Megumi'],
	'desc': 'ライブ会場は、蓮ノ空女学院の音楽堂。3ユニットが「伝統曲」を披露する。<br>このFes×LIVEはストーリー第11話との密接なつながりがあるため、公式ではストーリーと抱き合わせで配信されている（右のリンクではライブ部分から視聴開始になるようになっている）。',
},
{
...
},
{
	...
	'title': 'みらくら綴理ぱーくだ！',
	'tube': 'ZIO4HLN5x-g',
	'tags': ['meets', 'Tsuzuri', 'Rurino', 'Megumi'],
	'desc': ''
},
{
...
},
{
	...
	'tube': '11Of9XcxMO4&t=4152s',
	'tags': ['live', 'Kaho', 'Sayaka', 'Kozue', 'Tsuzuri', 'Rurino', 'Megumi'],
	'desc': '今月のFes×LIVEは二部構成！ 第1部はハロウィンをテーマとしたライブ！<br>この回のFes×LIVE AFTERでは、リアルタイムでの投票機能が初めて使用された。<br>このFes×LIVEはストーリー第12話との密接なつながりがあるため、公式ではストーリーと抱き合わせで配信されている（右のリンクではライブ部分から視聴開始になるようになっている）。',
...
},
{
	...
	'tube': 'QRXO3FoWLG4',
	'tags': ['meets', 'Kozue'],
	'desc': '梢が、蓮ノ空女学院のこと、スクールアイドルクラブのこと、そしてメンバーのことについての話を繰り広げる。「AFTER」では機械トラブルにより、音が途切れ途切れになってしまっている。<br>この配信は、蓮ノ空女学院スクールアイドルクラブ公式YouTubeでも同時配信された。YouTube上では、アーカイブは「動画」ではなく「ライブ」タブにある。'
},
{
