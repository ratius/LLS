const ArenaData = [
	...
	'Opponent': [
		...
		{'name': 'Reine', 'text': 'よ～し、麗音からが本当のゴールデンライブの始まりだよっ！<br>みんな～！　ぴっかぴかのダンスを楽しんでねー！！<br>……水星の逆行は<span class="ul">GW後<\/span>って遊宇から聞いたのは黙っとこっと<br><div class="note">※水星の逆行運動は、2022年5月10日からしばらく観測することができた。つまり時事ネタ。<\/span'},
	...
	'Opponent': [
		...
		{'name': 'geass', 'num': '5', 'namealt': 'アーニャ', 'text': '間に合った？　なんとか……<br>良かった。なんかあるとジェリー<div class="note">※<\/div>怒るから<br><div class="note">※「ジェリー」とは、ジェレミア・ゴットバルトのこと。<\/div>'},
