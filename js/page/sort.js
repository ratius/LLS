...
const wrtieResult = () => {
	...
	const TweetButton = `<button id="TweetButton" onclick="window.open().location.href='https://twitter.com/intent/tweet?text=${TweetURI}'"><img src="img/x-logo-white.png" style="width:25px; height:25px">この結果をポスト</button>`;
