const ArenaData = [
	...
	'Opponent': [
		...
		{'name': 'Rakshata', 'text': '私は本場仕込みのベリーダンスを踊ります……☆<br>あ、あら……？　お客様がみんな夢見心地に……<br>お客様のチャクラを海岸してしまったみたいです……☆'},
		...
		{'name': 'Yumi', 'text': '私はバイオリンを弾くわ<br>美しい音色は目をつぶって聞き入らせてしまう力があるのよ<br>音楽というものの魅力は偉大よね'},
	...
	'Opponent': [
		...
		{'name': 'Nanaka', 'text': '大変大変！　どうやら子供のライオンが<br>近くの動物園から逃げ出したそうなんだ！<br>衣装部屋を荒らしたのって、もしかして……'},
		...
		{'name': 'Tsurugi', 'text': 'ど、どうしよう！？　子供とはいえライオンなんて<br>う、うろたえてちゃいけないよね！　私も念の為、竹刀を<br>持ってきた方がいいかな……？　いや、まず避難誘導だよね！'},
		...
		{'name': 'Minami', 'text': 'まあ……猫ちゃん！　可愛い～♡お腹空いていますかね？　これ、私が作った特製の<br>キャットフードなんですが、よかったらいかがでしょう？'},
